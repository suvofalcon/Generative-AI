...
# This module provides a way to interact with the operating system, such as accessing environment variables,
# working with files and directories, executing shell commands, etc
import os

# Helps us generate embeddings An embedding is a vector (list) of floating point numbers. The distance between two
# vectors measures their relatedness. Small distances suggest high relatedness and large distances suggest low
# relatedness.
...
# large-scale datasets, particularly with high-dimensional vectors. It provides optimized indexing structures and
# algorithms for tasks like nearest neighbor search and recommendation systems.
