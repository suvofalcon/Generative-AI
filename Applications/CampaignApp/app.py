...
def getLLMResponse(query, age_option, tasktype_option):
    ...
    print(new_prompt_template.format(template_user_input=query, template_age_option=age_option, template_tasktype_option=tasktype_option))
    response = llm(new_prompt_template.format(template_user_input=query, template_age_option=age_option, template_tasktype_option=tasktype_option))
    print(response)
